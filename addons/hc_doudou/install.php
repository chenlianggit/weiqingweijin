<?php
pdo_query("
CREATE TABLE ".tablename('hcdoudou_address')." (
...
CREATE TABLE ".tablename('hcdoudou_cash')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE ".tablename('hcdoudou_checkgoods')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `weid` int(11) NOT NULL,
...
CREATE TABLE ".tablename('hcdoudou_commission')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE ".tablename('hcdoudou_goods')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `weid` int(11) NOT NULL,
  `title` varchar(200) NOT NULL,
  `model` varchar(200) NOT NULL,
...
CREATE TABLE ".tablename('hcdoudou_guan')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE ".tablename('hcdoudou_nexus')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE ".tablename('hcdoudou_order')." (
...
CREATE TABLE ".tablename('hcdoudou_paylog')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `weid` int(11) NOT NULL,
  `money` decimal(10,2) NOT NULL,
  `uid` int(11) NOT NULL,
...
CREATE TABLE ".tablename('hcdoudou_setting')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE ".tablename('hcdoudou_upgrade')." (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE ".tablename('hcdoudou_users')." (
